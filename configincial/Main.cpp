...
const GLchar* fragmentShaderSource = 
{
	...
	"void main()\n"
	"{\n"
	"color = vec4(1.0f, 0.5f, 0.2f, 1.0f);\n" //green, red, blue, 1 es de transparencias
	"}\n\0"
};
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glClearColor(0.2f, 0.3f, 0.3f, 1.0f); //color del fondo
		...
		glBindVertexArray(VAO);
		glDrawArrays(GL_TRIANGLES, 0, 3); //dibujar el primer triangulo
		glBindVertexArray(0);
...
void CrearShader()
{
	...
	GLint success;
	GLchar infoLog[512]; //identificador
