...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = glm::rotate(view, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0f)); //aplicamos traslación y rotaciíon a la vista
		...
		//hacemos el "pivote" del hombro, ya que modelTemp va a ser nuestro pivote o articulación
		...
		//hacemos el "pivote" del codo, ya que modelTemp va a ser nuestro pivote o articulación
		...
		//hacemos el "pivote" de la mano, ya que modelTemp va a ser nuestro pivote o articulación
